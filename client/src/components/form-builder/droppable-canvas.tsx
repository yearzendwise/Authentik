...
export function DroppableCanvas({
  ...
  if (previewMode) {
    return (
      <div className="flex-1 p-6 overflow-y-auto bg-neutral-50 min-h-0">
  ...
  return (
    <div className="flex-1 p-3 md:p-6 overflow-y-auto bg-gradient-to-br from-slate-50 via-blue-50/20 to-indigo-50/30 min-h-0">
