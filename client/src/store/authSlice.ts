...
export const loginUser = createAsyncThunk(
  'auth/login',
  async (credentials: { email: string; password: string; twoFactorToken?: string }, { rejectWithValue }) => {
    try {
...
export const { setAccessToken, clearAuth, setError, clearError, setInitialized } = authSlice.actions;
